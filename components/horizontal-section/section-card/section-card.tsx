import { SongsRecord } from "@/pocketbase-types";
      ...
      <View style={{ position: "relative" }}>
        ...
        <IconButton
          ...
          icon={getPlayerIcon({
            ...
            playing,
            isCurrent:
              pb.files.getUrl(props.song, props.song.file ?? "") === track?.url,
          })}
          size={45}
          mode="contained"
          iconColor="#fff"
          ...
          onPress={async (e) => {
            ...
            if (!thisTrack) {
              TrackPlayer.add(
                [{ url: pb.files.getUrl(props.song, props.song.file ?? ""), title: props.song.name }],
